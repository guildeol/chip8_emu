...
CpuMemory::CpuMemory()
{
  ...
  // representing the hexadecimal numbers from 0 through F. Each font character
  // should be 4 pixels wide by 5 pixels tall. These font sprites are drawn just
  // like regular sprites.
